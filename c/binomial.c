...
int main()
{
    ...
    if (p >= 0 && p <= 1)
    {
        ...
        if (r >= 0 && r <= n)
        {
            ...
            case 2:
                s = 0;
                printf("The event is happening %d times out of which the probability of success of the event is %f then find the probability to get at most %d successes?", n, p, r);
                for (int i = 0; i <= r; i++)
                {
                    a = (fact(n) / (fact(n - i) * fact(i))) * pow(p, i) * pow(q, (n - i));
                    s = s + a;
            ...
            case 3:
                printf("The event is happening %d times out of which the probability of success of the event is %f then find the probability to get %d successes?", n, p, r);
            ...
            case 4:
                printf("The event is happening %d times out of which the probability of success of the event is %f then find the probability to not get %d successes?", n, p, r);
